...
class ConversationUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conversation_user" do
    assert_difference('ConversationUser.count') do
      post conversation_users_url, params: { conversation_user: { conversation_id: @conversation_user.conversation_id, role: @conversation_user.role, unread_count: @conversation_user.unread_count, user_id: @conversation_user.user_id } }, as: :json
    end
  ...
  test "should update conversation_user" do
    patch conversation_user_url(@conversation_user), params: { conversation_user: { conversation_id: @conversation_user.conversation_id, role: @conversation_user.role, unread_count: @conversation_user.unread_count, user_id: @conversation_user.user_id } }, as: :json
    assert_response 200
  end
